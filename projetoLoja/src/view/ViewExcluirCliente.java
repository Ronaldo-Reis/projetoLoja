 ...
 * @author Ronaldo
 */
public class ViewExcluirCliente extends javax.swing.JFrame {

    /**
     * Creates new form ViewListaCliente
     */
    public ViewExcluirCliente() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewExcluirCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewExcluirCliente().setVisible(true);
            }
        });
    }
